...
class CycleCountProduct {
  ...
  final String? actualExpiredDate1;
  final String? actualLotNumber1;
  final String? actualManufactureDate1;
  final int actualQty2;
  final String? actualExpiredDate2;
  final String? actualManufactureDate2;
  final int? systemQty1;
  final int? systemQty2;
  final String? systemLotNumber1;
  final String? systemLotNumber2;
  final String? systemExpiredDate1;
  final String? systemExpiredDate2;
  final String? systemManufactureDate1;
  final String? systemManufactureDate2;
